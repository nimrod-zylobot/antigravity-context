...
async function main() {
    ...
    // Search query for any messages containing "myvarni"
    const query = 'myvarni';
    ...
    if (!listData.messages || listData.messages.length === 0) {
        console.log('No messages found containing "myvarni".');
        return;
    }

    console.log(`Found ${listData.messages.length} messages for "myvarni":\n`);
